...
workers.gatherAllChecks = function() {
  ...
  _data.list('checks',function(err,checks) {
      ...
      //SVM
      console.log('in gatherAllChecks err: ', err);
...
workers.validateCheckData = function(originalCheckData) {
    ...
    //SVM
    console.log('originalCheckData in validateCheckData: ', originalCheckData);
  ...
  originalCheckData.successCodes = typeof(originalCheckData.successCodes) == 'object'
                              && origincalCheckData.successCodes instanceof Array
                              && originalCheckDAta.successCodes > 0
...
workers.alertUserToStatusChange = function(newCheckData) {
  ...
  helpers.sendTwilio.Sms(newCheckData.userPhone,msg,function(err){
    if(!err) {
...
workers.log = function(originalCheckData,checkOutcome,state,alertWarranted,timeOfCheck){
  ...
  _logs.append(logFilenName,logString,function(err){
    if(!err) {
